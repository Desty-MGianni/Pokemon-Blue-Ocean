...
'''
This file is where every instances of Road, Citiy and inherited classes are created.
At the end of this file, the relationship between all the instances are established in a dictionary. which is called in where_to_go() function in script.py
'''
